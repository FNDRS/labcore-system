    ...
    <Table>
      <TableHeader>
        <TableRow className="border-zinc-200 hover:bg-transparent">
          ...
          <TableHead className="text-muted-foreground font-medium">Examen</TableHead>
          <TableHead className="text-muted-foreground font-medium">Técnico</TableHead>
          <TableHead className="text-muted-foreground font-medium">Procesado</TableHead>
      ...
      <TableBody>
        {items.map((row) => {
          const isCritical =
            highlightCritical && (row.clinicalFlag !== "normal" || row.hasReferenceRangeViolation);
          ...
          return (
            <TableRow
              ...
              className={cn(
                ...
                isCritical && "bg-red-50/50 dark:bg-red-950/20 border-l-2 border-l-red-400"
              )}
            >
              ...
              <TableCell className="text-zinc-600">{row.technicianId ?? "—"}</TableCell>
