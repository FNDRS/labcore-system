...
export default async function SupervisorValidacionDetailPage({ params, searchParams }: Props) {
  try {
          ...
          <Card className="rounded-xl border border-zinc-200 bg-white shadow-none">
            ...
            <CardContent>
              <p className="text-muted-foreground text-sm">
                No pudimos cargar la validación solicitada. Puede haber sido eliminada o no estar
                disponible.
              </p>
            </CardContent>
          </Card>
