...
// Paths as constants to avoid hydration mismatch (no tab/whitespace or bundler differences)
const PATH_ACTIVE =
...
export function HomeSidebarIcon({ className, active }: Props) {
  return (
    <span className={className} aria-hidden>
      <svg
        ...
        fill="currentColor"
      >
        <path d={active ? PATH_ACTIVE : PATH_INACTIVE} />
      </svg>
    </span>
  );
}
