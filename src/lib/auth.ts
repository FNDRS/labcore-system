 ...
 */
export const AUTH_GROUPS = ["tecnico", "supervisor", "admin", "doctor", "recepcion"] as const;
 ...
 */
export const ROLE_PRIORITY: AuthGroup[] = ["admin", "supervisor", "doctor", "tecnico", "recepcion"];
 ...
 */
export function hasAccessToPath(userGroups: AuthGroup[], pathname: string): boolean {
